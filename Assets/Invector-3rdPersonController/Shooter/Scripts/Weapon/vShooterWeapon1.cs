...
namespace Invector.vShooter
{
    ...
    public class vShooterWeapon1 : vMonoBehaviour
    {
        #region variables
        ...
        public UnityEvent onShot, onReload,onFinishReload, onEmptyClip, onEnableAim, onDisableAim, onEnableScope, onDisableScope, onFullPower;
